"use client";
import { mapsUrlFromAddress } from "@/lib/utils/maps";
...
export default function TrackableAddress({
  address, venueId, context, className,
  ...
  return (
    <a
      ...
      className={
        className ??
        "inline-flex items-center gap-1 text-sm text-gray-700 hover:text-orange-600 font-medium transition-colors"
      }
